                ...
                <?php if ($arResult['reviews']):?>
                    <div class="reviews__list list-reset">
                        ...
                        <div class="reviews__link-wrapper">
                            <?php if ($item['review_btn_text']||$item['review_btn_link']):?>
                                <a href="<?= $item['review_btn_link']?>" class="btn btn-primary btn-reset reviews__btn"><?= $arResult['review_btn_text']?></a>
                            <?php endif;?>
                            <?php if ($item['comment_btn_text']||$item['comment_btn_link']):?>
                                <a href="<?= $item['comment_btn_link']?>" class="btn btn-secondary btn-reset reviews__btn"><?= $arResult['comment_btn_text']?></a>
                            <?php endif;?>
                        </div>
                    </div>
                <?php endif;?>
